...
![Bilinear Interpolation Concept](./TermProject/assets/bilinear-interpolation-concept.png)

20×20 입력 이미지는 행과 열 방향으로 각각 4배 확대되어 80×80 결과 이미지가 된다.

![Input and Output Structure](./TermProject/assets/input-output-structure.png)

아래 그림은 작은 입력 행렬이 확대될 때 보간 픽셀이 어떻게 생성되는지 보여준다.

![Bilinear Interpolation Example](./TermProject/assets/bilinear-interpolation-example.png)
